...
class GraphRAGService:
        ...
        if self.vector_store:
            try:
                ...
                if not neo_ids and docs:
                    ...
                    if not neo_ids:
                        try:
                            with self.driver.session() as sess2:
                                for d in docs:
    ...
    def local_search(self, question: str, top_k: int = 5, include_community: bool = True, doc_id: str = None) -> Dict[str, Any]:
...
请输出摘要报告："""
    ...
    def global_search(self, question: str, max_communities: int = 10, 
                      include_intermediate: bool = False, doc_id: str = None) -> Dict[str, Any]:
...
请输出最终答案："""
    ...
    def hybrid_search(self, question: str, top_k: int = 5, 
                      strategy: str = "auto", chat_history: list = None, doc_id: str = None) -> Dict[str, Any]:
