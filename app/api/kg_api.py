...
def list_documents():
    ...
    try:
        ...
        results = rag_service.graph_service.execute_query(cypher, {})
...
def get_visualize_data():
    ...
    try:
        ...
        rels_data = rag_service.graph_service.execute_query(cypher, params)
...
def list_communities():
    ...
    try:
        ...
        results = rag_service.graph_service.execute_query(cypher, params)
...
def graphrag_local_search():
    ...
    try:
        ...
        result = svc.local_search(question, top_k=top_k, include_community=include_community)
        return jsonify({"success": True, "data": result})
...
def graphrag_hybrid_search():
    ...
    try:
        ...
        result = svc.hybrid_search(question, top_k=top_k, strategy=strategy, chat_history=chat_history, doc_id=doc_id)
